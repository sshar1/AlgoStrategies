...
class AlgoStrategy(gamelib.AlgoCore):
    ...
    def starter_strategy(self, game_state):
        ...
        if (path_blocked and game_state.turn_number > 4) or self.counter_infiltrator_strat:
    ...
    def should_spawn_scouts(self, game_state, damage_taken):
        ...
        return ((num_scouts * 17) / damage_taken) >= 2.8
    ...
    def on_action_frame(self, turn_string):
        ...
        if self.last_enemy_spawn_update != spawns:
            ...
            safest_spawn, least_damage = self.least_damage_spawn(self.game_state)
            path_blocked, end_location = self.wall_blocking_path(self.game_state, safest_spawn)
